        ...
        <div class="flex items-center justify-between px-1">
          ...
          <div class="flex items-center">
            <button
              ...
              class="focus:text-gray-600 hover:text-gray-600 text-gray-800 dark:text-gray-100"
            ...
            ><button
              ...
              class="focus:text-gray-600 hover:text-gray-600 ml-3 text-gray-800 dark:text-gray-100"
                ...
                >
                  <Menu as="div">
                    <MenuButton
                      ...
                      class="px-2 py-2 rounded-full flex w-full justify-center hover:bg-background hover:text-gray-600"
                    >
                      {{ day }}
                    </MenuButton>
                  </Menu>
